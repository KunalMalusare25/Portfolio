...
function EmailSection() {
  ...
  const handleSubmit = async (event) => {
    ...
    submitData.append("access_key", "bc642823-59f4-4230-b7eb-ba7d0c7035ee");
    try {
    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-5">
          <Link href="https://github.com/KunalMalusare25">
            <Image
              src="/images/githubbbb.svg"
              alt="Git Hub Icon"
              width={40}
              height={40}
            />
          </Link>
          <Link href="https://www.linkedin.com/in/kunal-malusare-387a73240/">
            <Image
